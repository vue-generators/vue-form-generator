...
.row(v-show="model")
    .col-md-5.col-md-offset-1
        ...
        vue-form-generator(:schema='schema', :model='model', :options='formOptions', :multiple="selected.length > 1", v-ref:form, :is-new-model="isNewModel", :is-edit-mode="isEditMode")
